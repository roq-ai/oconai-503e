...
import { getOptionContractById } from 'apiSdk/option-contracts';
...
function OptionContractViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Option Contract Detail View
          </Text>
          {hasAccess('option_contract', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/option-contracts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
